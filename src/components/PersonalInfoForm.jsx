...
import {baseurl, saveUserinfo} from "../services/service.js";
import {loadingSelector, setstep, setuser, userselector, setloading} from "../slices/userSlice.js";
...
const PersonalInfoForm = () => {
    ...
    const validationSchema = yup.object({
        ...
        nationality: yup.string().max(50, ' باید کوتاه تر باشد'),
            ...
            <form onSubmit={formik.handleSubmit} className='yekan-regular'>
                <Grid container columnSpacing={3} rowSpacing={5}
                        ...
                        <FormControl className='w100' variant="standard">
                            ...
                            >
                                ...
                                <MenuItem className='yekan-regular' value={1}> پایان خدمت / معافیت
                                    دائم</MenuItem>
                                <MenuItem className='yekan-regular' value={2}>معافیت
                                    تحصیلی/موقت</MenuItem>
                    ...
                    <Grid xs={12} sm={12} md={12} sx={{textAlign: 'center'}}>
                        {
                            reduxloading ? <Spinner/> : <Button className='yekan-regular' type='submit'
